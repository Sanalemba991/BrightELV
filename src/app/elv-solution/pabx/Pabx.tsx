...
import { Headphones, Users, Shield, Phone } from "lucide-react";
    ...
    <>
          ...
          <div className="flex-1 flex flex-col items-center justify-center">
            ...
            >
              <motion.p className="text-white/70 text-sm text-center leading-relaxed max-w-xs">
                Advanced business phone systems for seamless internal and external communication.
              </motion.p>
              <motion.div
      ...
      <div className="overflow-x-hidden bg-white">
        <div className="max-w-7xl mx-auto">
          {/* Section 01 & Image - High-Resolution Audio - FIXED FOR MOBILE */}
