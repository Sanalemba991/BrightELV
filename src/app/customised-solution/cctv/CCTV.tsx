  ...
  return (
    <>
        ...
        >
          ...
          <div className="flex-1 flex flex-col items-center justify-center">
            ...
            >
              <motion.p className="text-white/70 text-sm text-center max-w-sm">
                State-of-the-art security solutions for Dubai
              </motion.p>
              <motion.div
          ...
          <div className="pb-12 px-6 md:px-12 hidden md:flex flex-col items-start md:items-end md:flex-row md:justify-between gap-4 md:gap-0">
            ...
            >
              ...
              >
                At Brightelv, we understand the critical importance of security
                in today’s world. As a leading provider of custom CCTV consoles
                in Dubai, we are dedicated to delivering state-of-the-art
                solutions tailored to meet the unique security needs of our
                clients.
              </motion.p>
            ...
            <div className="flex flex-col">
              ...
              >
                ...
                <p className="text-gray-500 text-base leading-relaxed max-w-md">
                  Brightelv proudly serves a diverse range of industries in
                  Dubai, including corporate offices, retail spaces, healthcare
                  facilities, educational institutions, and the hospitality
                  sector, delivering tailored CCTV and security solutions that
                  combine reliability, efficiency, and seamless design.
                </p>
                <p className="text-gray-500 text-base leading-relaxed max-w-md">
                  We provide complete projector mounting solutions, including
                  custom stands and ceiling mounts with adjustable positioning,
                  clean cable management, expert consultation with 3D design,
                  professional installation, and reliable ongoing support for a
                  flawless setup.
                </p>
              </motion.div>
      ...
      <motion.section
        ...
        className="bg-gray-50 overflow-x-hidden text-black py-20 md:py-28"
      >
