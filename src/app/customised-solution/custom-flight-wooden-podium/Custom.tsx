          ...
          <div className="flex-1 flex flex-col items-center justify-center">
            ...
            >
              <motion.p className="text-white/70 text-sm text-center max-w-sm">
                Welcome to Brightelv, Dubai's trusted provider of custom flight cases and elegant wooden podiums
              </motion.p>
              <motion.div
      ...
      <motion.section
            ...
            >
              <div className="max-w-5xl mx-auto px-6 text-center">
                ...
                >
                  Why choose Bright<span className="text-blue-900">elv</span> Flight Case
                </motion.h2>
                <motion.div
