...
const Projector = () => {
  ...
  return (
    <>
      ...
      <div className="relative overflow-x-hidden w-full h-96 md:h-screen bg-black overflow-hidden">
        ...
        >
          ...
          <div className="flex-1 flex flex-col items-center justify-center">
            ...
            >
              <motion.p className="text-white/70 text-sm text-center max-w-sm">
                At Brightelv, Dubai's premier provider of custom projector
                stands and ceiling mounts. We understand the importance of
                precise, reliable, and aesthetically pleasing projector
                installations for both residential and commercial spaces.
              </motion.p>
              <motion.div
          ...
          <div className="pb-12 px-6 md:px-12 hidden md:flex flex-col items-start md:items-end md:flex-row md:justify-between gap-4 md:gap-0">
            ...
            >
              ...
              >
                At Brightelv, Dubai’s premier provider of custom projector
                stands and ceiling mounts. At Brightelv, we understand the
                importance of precise, reliable, and aesthetically pleasing
                projector installations for both residential and commercial
                spaces. Our mission is to offer bespoke solutions that perfectly
                match your unique requirements, ensuring optimal performance and
      ...
      <section
        ref={section1Ref}
        className="px-4 overflow-x-hidden md:px-8 lg:px-16 bg-white py-16"
      >
      ...
      <section
        ...
        className="py-16 px-6 md:px-12 overflow-x-hidden lg:px-20 bg-white overflow-hidden"
      >
        <div className="max-w-7xl mx-auto">
          <motion.div
